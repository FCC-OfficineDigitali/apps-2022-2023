					...
					<Grid container direction={"column"}>
						<Grid item>
							<Typography variant="h1" style={{ fontSize: lg ? 36 : 18 }}>
								{sm ? "Segnalazioni Treviso-Ostiglia" : "Segnalazioni"}
							</Typography>
						</Grid>
						{lg && <Grid item>
							<Typography variant="subheader">
								L'app di raccolta segnalazioni della Treviso-Ostiglia
							</Typography>
						</Grid>
						}
					</Grid>
					{
						...
						<>
							...
							<Box ml={sm ? 4 : 1}>
								{
									sm ?
										<StyledOutlinedButton onClick={_ => setOpen(true)} sx={{ fontFamily: "Graphik", fontSize: 15 }}>
											Logout
										</StyledOutlinedButton>
										:
