			...
			<AppBar position="fixed" ref={nav} elevation={0} sx={{ bgcolor: theme.palette.primary.white }}>
				<Toolbar style={{ padding: "0.5% 4% 0%" }}>
					...
					<Grid container direction="column">
						<Grid item>
							<Typography variant="h1" style={{ fontSize: lg ? 36 : 18 }}>
								SmartLab-Amministratore
							</Typography>
						</Grid>
						{lg && <Grid item>
							<Typography variant="subheader">
								Amministra le prenotazioni dell'Innovation Lab del Camposampierese
							</Typography>
						</Grid>
						}
					</Grid>
					{
						user &&
						<>
							<IconButton onClick={_ => { window.location.href = "https://officinedigitali.fcc.veneto.it/SmartLabCMS/" }}>
								<AdminPanelSettings style={{ color: theme.palette.primary.main }} />
							</IconButton>
							<Box ml={1}>
