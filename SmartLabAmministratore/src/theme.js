...
const filledTextFieldLighter = "#FBFBFF";
const filledAccordionLighter = "#FEFEFF";
const white = "#FFFFFF";
const green = "#5DC937";
const red = "#FF0000";
...
export default createTheme({
    palette: {
        primary: {
            ...
            filledTextFieldLighter: filledTextFieldLighter,
            filledAccordionLighter: filledAccordionLighter,
            white: white,
            green: green,
