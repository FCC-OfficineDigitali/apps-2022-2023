...
import ChangeCredentialsDialogBtnComp from "./ChangeCredentialsDialogBtnComp";
import ShowBuildingInfoDialogBtnComp from "./ShowBuildingInfoDialogBtnComp";
			...
			<AppBar position="fixed" ref={nav} elevation={0} sx={{ bgcolor: theme.palette.primary.white }}>
				<Toolbar style={{ padding: "0.5% 4% 0%" }}>
					...
					<Grid container direction="column">
						...
						{lg && <Grid item>
							<Typography variant="subheader">
								Prenota il tuo posto nell'Innovation Lab del Camposampierese
							</Typography>
						</Grid>
						}
					</Grid>
					{
						user &&
						<>
							<ShowBuildingInfoDialogBtnComp bluCamposampierese={theme.palette.primary.main} />
							<Box ml={1}>
								<ChangeCredentialsDialogBtnComp bluCamposampierese={theme.palette.primary.main} />
							</Box>
							<Box ml={1}>
