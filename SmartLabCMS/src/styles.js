...
const StyledCellTextField = styled(TextField)(({ theme, value }) => ({
  "& .MuiInputBase-root": {
    ...graphikForComponents,
    color: theme.palette.primary.functionalBlackCamposampierese,
    padding: 0
...
export { StyledTextButton, StyledOutlinedButton, StyledFab, StyledDivider, StyledAutocomplete, StyledMenuItem, StyledCellTextField, StyledFilledTextField, StyledOutlinedTextField, StyledSelect, StyledTab, StyledTableCell };