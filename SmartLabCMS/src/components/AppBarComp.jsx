			...
			<AppBar position="fixed" ref={nav} elevation={0} sx={{ bgcolor: theme.palette.primary.white }}>
				<Toolbar style={{ padding: "0.5% 4% 0%" }}>
					...
					<Grid container direction="column">
						...
						{lg && <Grid item>
							<Typography variant="subheader">
								Il back office dell'Innovation Lab del Camposampierese
							</Typography>
						</Grid>
						}
					</Grid>
					{
						user &&
						<>
							<IconButton onClick={_ => { window.location.href = "https://officinedigitali.fcc.veneto.it/SmartLabAmministratore/" }}>
